...
class BakeHouse:
    ...
    def deallocate_table(self, table_number):               
        x=self.__occupied_table_list.find_node(table_number)
        if x is not None:                                   
            self.__occupied_table_list.delete(x.get_data()) 
